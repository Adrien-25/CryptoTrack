...
const SearchBar: React.FC<RechercheProps> = ({ onSearch, toggleSearchBar, className }) => {
  ...
  return (
    <div
      ...
      // opacity-0 visibility-hidden translate-x-full

      // className="absolute top-0 bottom-0 right-0  bg-slate-800 flex items-center px-4 h-[48px] md:w-[500px] max-w-full w-full z-10"
    >
      <input
        type="text"
        value={query}
